                        ...
                        <div class="row row-cols-1 row-cols-md-3 gy-5 gx-1">
                            <div class="col">
                                <?php while ($pList01_Rows = $pList01->fetch()) { ?>
                                    <?php if ($i % 4 == 1) { ?>
                                        <div class="card text-center"><?php } ?>

                                        <img src="product_img/<?php echo $pList01_Rows['img_file']; ?>" class="card-img-top" alt="<?php echo $pList01_Rows['p_name']; ?>">
                                        <div class="card-body">
                                            <h5 class="card-title"><b><?php echo $pList01_Rows['p_name']; ?></b></h5>
                                            <p class="card-text">NT.<?php echo $pList01_Rows['p_name']; ?></p>
