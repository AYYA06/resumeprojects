<?php 
                    ...
                    <a href="drugstore.php" id="btn01" name="btn01" class="btn btn-primary"> 繼續購物</a>
                    <button type="button" class="btn btn-info" id="btn02" name="btn02" onclick="window.history.go(-1)">回到上一頁</button>
                    <button type="button" class="btn btn-success" id="btn03" name="btn03" onclick="btn_confirmLink('確定清空購物車?','shopcart_del.php?mode=2');">清空購物車</button>
                        ...
                        <table class="table table-hover mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="new-price pt-1" style="font-size:x-large">NT.<?php echo number_format ($cart_data['p_price']); ?></h4>
                                    </td>
                                    ...
                                    <td>
                                        <h4 class="new-price pt-1"style="font-size:x-large">NT.<?php echo   number_format ($cart_data['p_price'] * $cart_data['qty']); ?></h4>
                                    </td>
