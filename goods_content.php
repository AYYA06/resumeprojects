<div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-3">
                  ...
                  <div class="row mt-2">
                    <?php do { ?>
                      <div class="col-md-4"><a href="product_img/<?php echo $imgList['img_file']; ?>" rel="group" class="fancybox" title="<?php echo $data['p_name'];?>">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <h4 class="new-price">NT.<?php echo number_format ($data['p_price'])?></h4>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="input-group input-group-lg">
                                    <span class="input-group-text color-success" id="inputGroup-sizing-lg">數量</span>
                                    <input id="qty" name="qty" type="number" value="1" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                                </div>
                            </div>
                            <div class="col-md-6">
