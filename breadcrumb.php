<?php
        ...
        if(isset($_GET['p_id'])){
          ...
          $level1=$data['uplevel'];
          $level1Open='<li class="breadcrumb-item"><a href="drugstore.php?classid='.$level1Upclassid.'&level='.$level.'">'.$level1Cname.'</a></li>';
          //處理第二層
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php" class="text-hover">HOME</a></li>
